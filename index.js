...
const useAnimatedVisibility = (options = { threshold: 0.1, triggerOnce: true }) => {
...
const PortfolioPage = ({ projects, type }) => {
...
const AdminLogin = ({ setLoggedIn, adminPassword }) => {
...
const AdminDashboard = ({ projects, setProjects, adminPassword, setAdminPassword, setLoggedIn }) => {
...
const App = () => {
    const [projects, setProjects] = useLocalStorage('portfolio-projects', MOCK_PROJECTS);
    const [adminPassword, setAdminPassword] = useLocalStorage('admin-password', '0000');
